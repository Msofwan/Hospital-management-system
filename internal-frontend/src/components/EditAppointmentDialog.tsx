...
import type { AppointmentDetail, AppointmentPayload, Patient, StaffSummary } from '../types/hms';

interface EditAppointmentDialogProps {
  open: boolean;
  onClose: () => void;
  onEdit: (appointment: AppointmentPayload) => void;
...
export default function EditAppointmentDialog({ open, onClose, onEdit, appointment }: EditAppointmentDialogProps) {
  ...
  const loadSupportingData = async () => {
    try {
      ...
      console.error('Failed to fetch supporting data for appointment edit', error);
    } finally {
      setLoading(false);
    }
  };
